...
// parseAppFromNacos decodes nacos config content into an App.
func parseAppFromNacos(content string, key string) (app App, err error) {
	app = App{}
	_, err = toml.Decode(content, &app)
	if err != nil {
		return app, err
	}
